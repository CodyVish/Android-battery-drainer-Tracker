...
public class SharedPrefsUtils {
    ...
    public static void setSwitchStates(Context context,
        ...
        editor.putBoolean(DrainForegroundService.KEY_VIDEO, playVideo);
        editor.putBoolean(DrainForegroundService.KEY_OPEN, openApps);
        editor.putBoolean(DrainForegroundService.KEY_RECORD, recordVideo);
        editor.putBoolean(DrainForegroundService.KEY_VIBRATION, vibration);
        editor.apply();
    }

    public static boolean[] getSwitchStates(Context context) {
        boolean[]         switchStates      = new boolean[11];
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        ...
        switchStates[7] = sharedPreferences.getBoolean(DrainForegroundService.KEY_VIDEO, false);
        switchStates[8] = sharedPreferences.getBoolean(DrainForegroundService.KEY_OPEN, false);
        switchStates[9] = sharedPreferences.getBoolean(DrainForegroundService.KEY_RECORD, false);
        switchStates[10] = sharedPreferences.getBoolean(DrainForegroundService.KEY_VIBRATION, false);
        return switchStates;
    }
